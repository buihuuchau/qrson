<div class="row">
    <div class="col-sm-12 col-md-12 text-right">
        ...
        <div class="dataTables_paginate paging_simple_numbers pagination-number">
            ...
            <!-- Previous Page Link -->
                @if ($paginator->onFirstPage())
                    <li class="paginate_button page-item disabled"><a class="page-link">Trang trước</a></li>
                @else
                    <li class="paginate_button page-item"><a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev">Trang trước</a></li>
                @endif
            ...
            <!-- Next Page Link -->
                @if ($paginator->hasMorePages())
                    <li class="paginate_button page-item"><a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next">Trang sau</a></li>
                @else
                    <li class="paginate_button page-item disabled"><a class="page-link">Trang sau</a></li>
                @endif
